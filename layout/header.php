...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-light-warning elevation-4">
            <!-- Brand Logo -->
            <a href="home.php" class="brand-link mt-1">
                <img src="assets-template/dist/img/Logo.png" alt="Felicity Logo" class="brand-image img-circle elevation-2" style="opacity: .8">
                <span class="brand-text font-weight-light"><b>Felicity Store</b></span>
            </a>
